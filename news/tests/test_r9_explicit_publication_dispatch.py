...
class ExplicitR9PublicationDispatchTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.publisher = Path('.github/workflows/ppi-r9-explicit-publication.yml').read_text(encoding='utf-8')
    ...
    def test_collector_dispatches_only_after_dual_validation(self) -> None:
        ...
        self.assertIn('ppi-r9-explicit-publication.yml/dispatches', self.collector)
    ...
    def test_publication_refetches_and_binds_exact_source(self) -> None:
        ...
        self.assertIn("assert source['name'] == os.environ['EXPECTED_SOURCE_WORKFLOW']", self.publisher)
        ...
        self.assertIn("assert receipt['source_commit'] == source['head_sha']", self.publisher)

...
def main() -> int:
    parser = argparse.ArgumentParser(description="Fetch bounded Yahoo Finance expectation tables for R11 batch 3")
    ...
    if version != PINNED_YFINANCE_VERSION:

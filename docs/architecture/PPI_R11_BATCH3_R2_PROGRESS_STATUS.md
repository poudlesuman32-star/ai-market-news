...
Newer repository-level public-first observation supersedes the issue body only for freshness: chain-depth bridge `34723155484-1` failed on the historical OpenFIGI review artifact-lifetime gate on exact `ai-market-news` main `41976b8cd5f7f0758c2d5425fd2c7e6522634e1a`. It does not change R11 pilot evidence, registry credit, or downstream authority.

Newest producer remediation-controller run is `34722428581`, attempt `1`, schedule event, exact producer main `2bbef4dc81c65ab2ee2b723f1bd4de5e34a90e88`, completed `success` at `2026-09-12T22:19:37Z`. Reconcile job `103630629321` completed `success` and reported that `codex/ppi-r11-r2-provenance-attestation` is not ahead of `main`; merge `false`, acquisition `false`, publication `false`. This dependency-safe no-op does not change R11 evidence or credit.

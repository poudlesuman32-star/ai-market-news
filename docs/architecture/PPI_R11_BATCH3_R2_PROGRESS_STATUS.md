...
6. **Chain-depth bridge artifact-lifetime defect:** scheduled bridge `34852742832-1` still fails exact historical OpenFIGI review-artifact resolution before stable-ID/snapshot dispatch; repair must remain fail closed and zero-provider.

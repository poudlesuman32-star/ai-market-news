...
Fresh read-only prerequisite/control-plane observation on exact `ai-market-news` main `41976b8cd5f7f0758c2d5425fd2c7e6522634e1a`: latest immutable-snapshot-review bridge run `34869012045`, attempt `1`, completed `success`. Bridge job `104059981498` located stable-ID review `34081955551-1` and immutable snapshot `34082325289-1`, verified the exact immutable snapshot artifact, confirmed that an exact successful immutable review already exists, and skipped redispatch. The separate latest known chain-depth failure remains run `34852742832`, attempt `1`: bridge job `104004517541` located historical OpenFIGI review `33262596949-1`, then failed `Verify exact review receipt passed` because exact non-expired artifact `ppi-openfigi-mapping-artifact-review-33262596949-1` was not uniquely resolved; all stable-ID/snapshot dispatch steps were skipped. That failure remains the known zero-provider historical review-artifact lifetime defect. Neither observation regresses the retained prerequisites, creates pilot evidence, nor grants registry credit.
...
6. **Chain-depth bridge artifact-lifetime defect:** latest known failing chain-depth bridge `34852742832-1` still fails exact historical OpenFIGI review-artifact resolution before stable-ID/snapshot dispatch; later successful immutable-snapshot-review bridge `34869012045-1` confirms the retained downstream prerequisite path remains healthy but does not repair that historical artifact-lifetime defect.
